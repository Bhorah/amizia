	...
	return (
		<>
          ...
          <div className="col-first max-w-20 sm:max-w-md md:max-w-lg lg:max-w-xl">
			...
			{/** Engagements **/}
			<div id='engagements_anchor' className='grid grid-cols-2 gap-20 h-fit'>
				<div className='w-full h-full text-amizia-orange text-center'>
					<h2 className='text-3xl'>Nos engagements</h2>
					<div className='space-y-8 py-10 text-xl max-w-150 mx-auto'>
						<p>
							Amizia est née d’une passion commune pour les chevaux et d’un respect pour le savoir-faire
							traditionnel. Nous créons des tapis uniques au designs modernes et fonctionnels, associant
							l’élégance et l’authenticité des tissus importés du Maghreb.
						</p>
						<p>
							Chaque pièce est conçue avec soin, mettant en valeur des matières de qualité et des motifs
							inspirés de l’artisanat maghrébin. Engagés pour une production durable et éthique, nous
							travaillons avec des artisans qualifiés dans des conditions justes. Chaque tapis est conçu
							avec passion pour offrir confort et technicité tout en respectant nos valeurs : préservation
							du savoir-faire et responsabilité sociale.
						</p>
						<p>
							Notre objectif ? Offrir aux cavaliers des produits esthétiques, ergonomiques et durables,
							tout en soutenant un commerce responsable et valorisant des traditions textiles riches en
							histoire.
						</p>
					</div>
				</div>
